...
const facilities: Facility[] = [
  ...
  },
  {
    ...
    color: "from-[#8B5E3C] to-[#CFA57A]" // بني حضانة
  },
  {
    id: "sports",
    ...
    color: "from-[#1E7F5C] to-[#5EC4A1]" // أخضر نشط
  },
  {
    id: "campus",
    ...
    color: "from-[#D4C5B0] to-[#8B5E3C]" // كافيه دافي
  },
  {
    id: "environment",
...
const stages: Stage[] = [
  {
    ...
    image: "/images/kindergarten.jpeg",
    color: "from-[#8B5E3C] to-[#CFA57A]" // بني دافي
  },
  {
    id: "primary",
    ...
    image: "/images/classroom.jpeg",
    color: "from-[#1e3a5f] to-[#2a4d7f]" // أزرق
  },
  {
    id: "middle",
              ...
              {stages.map((stage, index) => (
                ...
                >
                  <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? "lg:grid-flow-dense" : ""}`}>
                    {/* Image */}
                    <div 
                      className={`relative h-80 lg:h-auto cursor-pointer group/image overflow-hidden ${index % 2 === 1 ? "lg:col-start-2" : ""}`}
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <div className="p-8 lg:p-10">
                      ...
                      <div className="mb-6">
                        <h5 className="font-bold text-[#1e3a5f] mb-3 flex items-center gap-2">
                          <svg className="w-5 h-5 text-[#C5A028]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                          </svg>
                          المنهج الدراسي
                        </h5>
          ...
          >
            ...
            <div className="p-8">
              ...
              <h4 className="text-xl font-bold text-[#1e3a5f] mb-4 flex items-center gap-2">
                <svg className="w-6 h-6 text-[#C5A028]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
